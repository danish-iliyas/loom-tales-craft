      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-display text-2xl font-bold text-accent">Loom Tales</h3>
            <p className="font-body text-sm leading-relaxed">
              Where art meets care. Expert carpet and shawl care services preserving heritage and craftsmanship.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2 font-body text-sm">
              <Link to="/services" className="elegant-underline inline-block hover:text-accent-dark">
                Our Services
              </Link>
              <Link to="/collection" className="elegant-underline inline-block hover:text-accent-dark">
                Collection
              </Link>
              <Link to="/about" className="elegant-underline inline-block hover:text-accent-dark">
                About Us
              </Link>
              <Link to="/faqs" className="elegant-underline inline-block hover:text-accent-dark">
                FAQs
              </Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-3 font-body text-sm">
              ...
              <div className="flex items-start gap-2">
                ...
                <span>123 Heritage Lane, Crafts District, Jaipur, Rajasthan</span>
              </div>
            </div>
          </div>
        </div>
